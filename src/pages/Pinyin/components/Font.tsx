...
const Font = () => {
  ...
  useEffect(() => {
  const value = SVG('my-font');
  const text = value.text('吃').font({ size: '40px' })

  const path = text.path('M10 80 C 40 10, 65 10, 95 80 S 150 150, 180 80');
  console.log(path);
}, [])
  ...
  return (
    ...
    <g transform="scale(1, -1) translate(0, -900)">
        {valuesss.strokes.map((strokePath, idx) => (
