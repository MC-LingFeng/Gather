...
const createShape = (font: opentype.Font, content: string,svg: SVGSVGElement) => {
  ...
  g.setAttribute('viewBox', [0, 0, (viewBox.width + viewBox.x).toFixed(2), (viewBox.height + viewBox.y).toFixed(2)].join(
    ' '));
}
...
const Font = () => {
  ...
  return (
    <div><svg version="1.1" viewBox="0 0 1024 1024" ref={ref} id='my-font' name='my-font'>
    {/* 田字格绘制 */}
    <g
        key="wordBg"
        stroke="var(--primary)"
